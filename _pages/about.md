...
<div style="display: flex; gap: 20px; margin-bottom: 30px;align-items: center;">
  <div style="flex-shrink: 0;">
    <img src="/images/iitm.png" alt="IIT Madras" width="150"/>
  </div>
  <div>
    <strong>Project Engineer</strong><br>
    <em>Image Guided Robotic Systems Lab, IIT Madras | May 2025 - Present</em><br>
    Chennai, Tamil Nadu, India<br>
    Advisor: Rahav Gowtham Venkateswaran, Senior Project Scientist for Computer Vision at IGRS-IIT Madras
    <ul>
      <li>Developing stereo and monocular camera algorithms and high accuracy vision pipelines for surgical tool tracking in intraoperative environments</li>
    </ul>
  </div>
</div>
...
<div style="display: flex; gap: 20px; margin-bottom: 30px;align-items: center;">
  <div style="flex-shrink: 0;">
    <img src="/images/ualberta.jpg" alt="University of Alberta" width="150"/>
  </div>
  <div>
...
<div style="display: flex; gap: 20px; margin-bottom: 30px;align-items: center;">
  <div style="flex-shrink: 0;">
    <img src="/images/nitt.png" alt="NIT Trichy" width="150"/>
  </div>
  <div>
...
<div style="display: flex; gap: 20px; margin-bottom: 30px;align-items: center;">
  <div style="flex-shrink: 0;">
    <img src="/images/iitindore.png" alt="IIT Indore" width="150"/>
  </div>
  <div>
...
<div style="display: flex; gap: 20px; margin-bottom: 30px; align-items: center;">
  <div style="flex-shrink: 0;">
    <img src="/images/ssn.png" alt="SSN College of Engineering" width="150"/>
  </div>
  <div>
    <strong>B.E. Computer Science and Engineering (Honors)</strong><br>
    <em>Sri Sivasubramaniya Nadar College of Engineering (SSN) | 2021 - 2025</em><br>
    Chennai, Tamil Nadu, India
    <ul>
      <li><strong>CGPA:</strong> 9.354/10</li>
      <li><strong>Department Rank:</strong> 2 out of 136</li>
      <li><strong>Honors in Artificial Intelligence and Machine Learning</strong> with 6 graduate-level courses</li>
      <li><strong>Undergraduate Thesis:</strong> A Multimodal Approach to Synthetic ECG and Clinical Report Generation</li>
    </ul>
  </div>
</div>